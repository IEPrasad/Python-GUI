...
class ClockApp(QMainWindow):
    def __init__(self):
        ...
        self.setGeometry(100, 100, 360, 340)  # Increased height to accommodate new button
        ...
        self.timer_reset_button = QPushButton("Reset Timer")
        self.timer_reset_button.setStyleSheet(button_style.replace("background-color: #45a049;", "background-color: #2196F3;"))
        ...
        timer_control_layout.addWidget(self.timer_reset_button)
